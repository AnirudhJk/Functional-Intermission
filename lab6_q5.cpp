...
/*Write a function that outputs the sum of all even numbers between firstNum and secondNum. (using loop); create a user-defined function called sumEvenNumbers(). Use call-by-value*/
